...
namespace Gaia
{
    ...
    public class ScreenShotter : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            {
                string path = Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments), m_buildTargetDirectory);
                if (!System.IO.Directory.Exists(path))
                {
                    System.IO.Directory.CreateDirectory(path);
                }
        ...
        private bool ScreenShotName(int width, int height, out string path)
        {
            ...
            {
                path = Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments), m_buildTargetDirectory);
                path = path.Replace('\\', '/');
